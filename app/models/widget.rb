class Widget < ApplicationRecord
    ...
    # return all enum integer values from largest to smallest
    def enum_values
      self.class.options_hash.values.sort.reverse
    end

    # subtract enum_values starting with largest, until left with 0
    ...
    # return the total possible number of combinations based on count of option_options
